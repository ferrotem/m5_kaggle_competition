...
CLASSIFIER = "PCAx2_GPU_2"#'Scaled+CNN+CD' +"_GPU_"+GPU #CNN+cat+date
SAMPLE_SIZE = 100
...
def full_model():
    ...
    x = Lambda(lambda x: tf.reshape(x, (1,4,185)))(x)#185 pca2, 192, pca1
...
df = pd.read_csv("boran_PCAx2_GPU_2.csv")
